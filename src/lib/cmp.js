...
//
// Functions in this file should register the callback with both __cmp and __tcfapi.
// The loaded CMP will only implement one of the two, ensuring the callback is only called once.
import log from './log';
...
// export const getGooglePersonalization = (view, callback) => {
// 	if (view.__tcfapi === undefined && view.__cmp === undefined) {
// 		return log.error('__tcfapi and __cmp are both undefined');
// 	}
//
// 	if (view.__tcfapi !== undefined) {
// 		view.__tcfapi('getTCData', 2, (data, success) => {
//
// 		})
// 	}
// 	if (view.__cmp !== undefined) {
// 		log.warn('__cmp is deprecated: use __tcfapi instead');
// 		view.__cmp('getGooglePersonalization', callback);
// 	}
// }
