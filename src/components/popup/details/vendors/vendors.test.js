...
describe('Vendors', () => {
	...
	it('should render the vendor list', () => {
		const vendors = render(<Vendors
			vendors={[
				{id: 1, name: 'Vendor 1', purposeIds: [44, 55]},
				{id: 2, name: 'Vendor 2', purposeIds: [55, 66]},
				{id: 3, name: 'Vendor 3', purposeIds: [54, 55, 56]},
				{id: 4, name: 'Vendor 4', purposeIds: [55]},
				{id: 5, name: 'Vendor 5', purposeIds: [99]}, // should be excluded
			]}
			theme={{}}
			selectedPurposeDetails={{id: 55}}
		/>, scratch);
